...
def list_of_users(list, user_list)
    ...
    loop do
        ...
        # Determine the number of times to loop though and create a user
        how_many = number_of_users.ask("Please enter the total number of people voting: ")
        ...
        if number > 0
            ...
            while index < number do 
                ...
                # Add each user object to an array
                user_list << new_user
                index += 1
            end
            break
